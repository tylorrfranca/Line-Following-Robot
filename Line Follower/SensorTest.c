...
//void CalculateReflectancePosition(void);
...
//    // Avoid division by zero (if no black is detected)
//    if (denominator == 0) {
//       distance = 0; // Default to center if no black detected
//    }

//    distance = (numerator / denominator)/10;  // Compute reflectance position
//}
